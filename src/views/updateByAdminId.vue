...
<script>
    export default {
        ...
        methods:{
            toregister(ruleForm){
                ...
                this.$refs[ruleForm].validate((valid) => {
                    if (valid) {
                        axios.post('http://localhost:8030/client/Accountclient/adminAccount',_this.user)
                            .then(function (res) {
                                if(res.data!=null&&res.data!=''){
                                    _this.ruleForm.id= _this.user.id;
                                    axios.post('http://localhost:8030/client/Accountclient/updateByAdminId',_this.ruleForm)
                                        .then(function (res) {
                                            if(res.data){
                                                //  添加成功后消息提示框
                                                _this.$message({
        ...
        created() {
            ...
            axios.get('http://localhost:8030/client/Accountclient/findByAdminId/'+id)
                .then(function (resp) {
